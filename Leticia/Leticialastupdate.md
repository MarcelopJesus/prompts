...
3. Cliente confirma: "Mas tá muito caro, não tenho condições" ou "Não, realmente não posso pagar agora"
4. **AGORA SIM** → Acionar protocolo de objeção financeira
...
✅ Só acione este protocolo quando cliente mencionar que não tem condições de pagar o valor da consulta pré-terapia
...
**PRÉ-REQUISITO ABSOLUTO:** Cliente JÁ passou nome + queixa, já enviamos sobre a TRI e  está em BLOCO 3 ou posterior
...
**SE cliente insiste EM BLOCOS 2, 3, 4, ou 5:**
→ Verificar: Já passamos pelo bloco 3 ? Já tentamos prosseguir para o Bloco 3.1 ?
   - ✅ SIM → Ir direto para BLOCO 6
   - ❌ NÃO → Continuar o fluxo até no mínimo o BLOCO 3, depois BLOCO 6
...
→ DEPOIS: Envie o conteúdo estruturado do BLOCO 1, adaptando para não repetir o que já foi respondido
...
SE o cliente já enviou nome + queixa na primeira mensagem:
→ Responda, envie o bloco adaptado (sem pedir novamente o que já foi informado) e avance para BLOCO 2
